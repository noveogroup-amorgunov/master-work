...
const HomePage = () => (
  <DocumentTitle title={t('Home page')}>
    <div>
      ...
      <p>Информационная система предназначена для предоставления удобного доступа пользователям к вычислительным ресурсам <b><a href="#">Сибирского Суперкомпьютерного центра</a></b> для выполнения задач <b><a href="#">перестановочного теста.</a></b></p> <p>Также система поддерживает возможность обмена опытом использования перестановочного теста и полученными результатами средствами электронной библиотеки и возможности открытого обсуждения опубликованных статей.</p>
      <h2>Публикации</h2>
